  ...
  return (
    <div>
      <div style={{display: "block"}}>
        <NewButton style={{display: "inline-block", margin: "10px"}} label={"Day3 문제보기"} onClick={() => {
          handleOnClick()
        }}/>
        <NewButton primary={true} style={{display: "inline-block", margin: "10px"}} label={"Day3 문제풀기"} onClick={() => {
          handleOnClick2()
        }}/>
      </div>
      <div>
